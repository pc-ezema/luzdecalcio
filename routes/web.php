...
Route::get('/donate', [App\Http\Controllers\HomePageController::class, 'donate']);
...
Route::get('/blog/view/{id}', [App\Http\Controllers\HomePageController::class, 'single_blog'])->name('single.blog');
