                                ...
                                <div class="row row-sm">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-4 is-invalid state-invalid" placeholder="Enter Password" required type="text" name="password">
                                        </div>
                                        <div class="form-group">
                                            <label>Confirm Password</label>
                                            <input class="form-control mb-4 is-invalid state-invalid" placeholder="Re-Enter Password" required type="text" name="">
                                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <div class="modal fade" id="view-{{$user->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="sendmessageLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <form method="Post" action="{{route('admin.admins.update', Crypt::encrypt($user->id))}}" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="mb-3">
                                                                            <input type="text" class="form-control" value="{{$user->user_type}}" name="name" required>
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <input type="file" class="form-control" value="{{$user->image}}" name="image">
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <input type="file" class="form-control" value="{{$user->email}}" name="file">
                                                                        </div>
                                                ...
                                                <div class="modal fade" id="delete-{{$user->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="sendmessageLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <form method="Post" action="{{route('admin.admins.delete', Crypt::encrypt($user->id))}}">
                                                            @csrf
                                                            <div class="modal-content">
                                                                <div class="modal-header">
